...
const WinnerCard: React.FC<WinnerCardProps> = ({ name, prizeAmount, ticketNumber, date, href, type, prizeName, winnerImage }) => {
   return (
      <>
         <div className="bg-white rounded-standard shadow-custom-1">
            ...
            <div className="flex flex-col justify-center items-center lg:gap-3 xl:gap-5 py-8 px-12 lg:py-12">
               <div className="text-themetwo text-big-one xl:text-big-five font-bold">Congratulations</div>
               <div className="text-darkone text-size-4 xl:text-head-4 text-center">{name} for winning {prizeAmount} Cash</div>
               ...
               <Link href={'/winners'} className="text-white shadow-custom-1 rounded-full px-12 py-4 bg-themeone mt-4 lg:mt-0 font-medium">Try Your Luck</Link>
            </div>
         </div>   
      </>
   )
