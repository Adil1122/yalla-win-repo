...
export default function AdminUpdatesSection() {
   ...
   async function onSubmit(file:any, type: any, thumbnail: any) {
      ...
      try {
         ...
         if (file.size > MAX_SIZE) {
            alert("Error: File size should not exceed 4.5MB");
            return;
         }
   ...
   return (
      <section className="bg-gradient-to-r from-themeone to-themetwo flex-grow px-12 py-20 flex-grow h-full">
         {isUploading && (
            <div className="text-white text-3xl flex-grow flex items-center justify-center h-full my-auto">Uploading. Please wait...</div>
         )}
         {
            !isUploading && (
               <>
                  <div className="flex flex-col gap-12 w-[92%] h-full">
                     <div className="flex flex-col gap-8">
                        ...
                        <div className="flex flex-col gap-2 w-full items-end">
                           <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-8 relative">
                           ...
                           <div className="flex gap-2">
                              <button onClick={handleHomeBannersPrev} type="button" className=" w-[40px] h-[40px] bg-transparent border-[3px] border-white p-2 flex items-center justify-center rounded-full">
                                 <FontAwesomeIcon icon={faChevronLeft} size="lg" className="text-white" /> 
                              </button>
                              <button onClick={handleHomeBannersNext} type="button" className=" w-[40px] h-[40px] bg-transparent border-[3px] border-white p-2 flex items-center justify-center rounded-full">
                     ...
                     <div className="flex flex-col gap-8">
                        ...
                        <div className="flex flex-col gap-2 w-full items-end">
                           ...
                           <div className="flex gap-2">
                              <button onClick={handleMobileHomeBannersPrev} type="button" className="w-[40px] h-[40px] bg-transparent border-[3px] border-white p-2 flex items-center justify-center rounded-full">
                                 <FontAwesomeIcon icon={faChevronLeft} size="lg" className="text-white" /> 
                              </button>
                              <button onClick={handleMobileHomeBannersNext} type="button" className="w-[40px] h-[40px] bg-transparent border-[3px] border-white p-2 flex items-center justify-center rounded-full">
                                 <FontAwesomeIcon icon={faChevronRight} size="lg" className="text-white" /> 
                              </button>
                           </div>
                        </div>
                     ...
                     <div className="flex flex-col gap-8">
                        ...
                        <div className="flex flex-col gap-2 w-full items-end">
                           ...
                           <div className="flex gap-2">
                              <button onClick={handleWinnersVideosPrev} type="button" className="w-[40px] h-[40px] bg-transparent border-[3px] border-white p-2 flex items-center justify-center rounded-full">
                                 <FontAwesomeIcon icon={faChevronLeft} size="lg" className="text-white" /> 
                              </button>
                              <button onClick={handleWinnersVideosNext} type="button" className="w-[40px] h-[40px] bg-transparent border-[3px] border-white p-2 flex items-center justify-center rounded-full">
                                 <FontAwesomeIcon icon={faChevronRight} size="lg" className="text-white" /> 
                              </button>
                           </div>
                        </div>
