               ...
               { 
                  winners.map((winner: any) => (
                     ...
                     <tr key={winner._id}>
                        ...
                        <td className="whitespace-nowrap px-4 lg:py-5 lg:px-8 text-sm lg:text-size-1 text-white text-center">{winner.game_name}</td>
                        ...
                        <td className="relative py-5 px-8 flex gap-2">
                           ...
                           <Link href={"raffle-games/details/" + winner._id} className="text-themeone font-medium px-4 py-1 lg:py-3 cursor-pointer lg:px-8 text-sm lg:text-size-1 bg-white rounded mx-auto w-fit">Details</Link>
                        </td>
                     </tr>
                  )))
               }
